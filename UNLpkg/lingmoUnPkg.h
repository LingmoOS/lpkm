/* lingmoUnPkg.h -- common declarations for all lingmoUnPkg modules
...
extern off_t header_bytes;/* number of bytes in lingmoUnPkg header */
...
#define	GZIP_MAGIC     "\037\213" /* Magic header for lingmoUnPkg files, 1F 8B */
#define	OLD_GZIP_MAGIC "\037\236" /* Magic header for lingmoUnPkg 0.5 = freeze 1.x */
#define	LZH_MAGIC      "\037\240" /* Magic header for SCO LZH Compress files*/
#define PKZIP_MAGIC    "\120\113\003\004" /* Magic header for pkzip files */

/* lingmoUnPkg flag byte */
#define ASCII_FLAG   0x01 /* bit 0 set: file probably ascii text */
#define HEADER_CRC   0x02 /* bit 1 set: CRC16 for the lingmoUnPkg header */
...
#  define Assert(cond,msg) {if (!(cond)) lingmoUnPkg_error (msg);}
...
extern int unlzh      (int in, int out);
        ...
        /* in lingmoUnPkg.c */
_Noreturn extern void finish_up_lingmoUnPkg (int);
_Noreturn extern void abort_lingmoUnPkg (void);
...
extern char *lingmoUnPkg_base_name (char *fname) _GL_ATTRIBUTE_PURE;
extern int xunlink        (char *fname);
extern void make_simple_name (char *name);
extern char *add_envopt   (int *argcp, char ***argvp, char const *env);
_Noreturn extern void lingmoUnPkg_error (char const *m);
