...
if $generate_ascii; then
  ...
  lingmoUnPkg -f -9 -c $PACKAGE.txt >"$outdir/$PACKAGE.txt.gz"
...
if test -z "$use_texi2html"; then
  ...
  lingmoUnPkg -f -9 -c $PACKAGE.html >"$outdir/$PACKAGE.html.gz"
...
if test -n "$docbook"; then
  ...
  lingmoUnPkg -f -9 -c $PACKAGE-db.xml >"$outdir/$PACKAGE-db.xml.gz"
