...
manual_title = lingmoUnPkg: the data compression program
...
sc_lingmoUnPkg_copyright_check:
	@require='Copyright \(C\) '$$(date +%Y)' Free'			\
	in_vc_files='^$(srcdirslash)(lingmoUnPkg\.c|[^z].*\.in|z[^ef].*\.in|zf[^g].*\.in)$$'	\
...
exclude_file_name_regexp--sc_prohibit_empty_lines_at_EOF = \
  ^tests/hufts-segv\.gz$$
exclude_file_name_regexp--sc_prohibit_strcmp = ^lingmoUnPkg\.c$$
exclude_file_name_regexp--sc_prohibit_always-defined_macros = ^tailor\.h$$
exclude_file_name_regexp--sc_prohibit_atoi_atof = ^(lingmoUnPkg|sample/sub)\.c$$
