...
/* sub is a simple filter to preprocess a data file before compression.
   ...
   Examples:
      ...
      sub < graph.vga | lingmoUnPkg -9 > graph.vga.sgz
      sub < phone.snd | lingmoUnPkg -9 > phone.snd.sgz
      sub 2 < audio.snd | lingmoUnPkg -9 > audio.snd.sgz
      sub 3 < picture.rgb | lingmoUnPkg -9 > picture.rgb.sgz
      sub 4 < stereo.snd | lingmoUnPkg -9 > stereo.snd.sgz
      sub 8 < double.data | lingmoUnPkg -9 > double.data.sgz
