 ...
 * - extend the documentation (at docs/lingmoGet.md)
 *
...
#ifndef WITH_ZLIB
			if (type == wget_content_encoding_lingmoUnPkg || type == wget_content_encoding_deflate)
				not_built = 1;
#endif
#ifndef WITH_BZIP2
...
static const struct optionw options[] = {
	...
	{ "compression", &config.compression, parse_compression, -1, 0,
		...
		{ "Customize Accept-Encoding with\n",
		  "identity, lingmoUnPkg, deflate, xz, lzma, br, bzip2, zstd, lzip\n",
