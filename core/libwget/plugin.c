...
/**
 * \file
 * \brief Plugin API for lingmoGet
 * \defgroup libwget-plugin Plugin API for lingmoGet
 * @{
 *
 * This is the plugin API for lingmoGet.
 *
...
/**
 * Marks the intercepted URL to be rejected. The URL will not be fetched by lingmoGet or passed to remaining plugins.
 *
 ...
 * The URL will not be passed to remaining plugins. lingmoGet will not filter the URL by any accept or reject pattern.
 *
