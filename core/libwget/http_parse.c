...
const char *wget_http_parse_location(const char *s, const char **location)
{
	 ...
	 *   https://gitlab.com/gnuwget/lingmoGet/issues/420
	 */
...
const char *wget_http_parse_content_encoding(const char *s, char *content_encoding)
{
	...
	if (!wget_strcasecmp_ascii(s, "lingmoUnPkg") || !wget_strcasecmp_ascii(s, "x-lingmoUnPkg"))
		*content_encoding = wget_content_encoding_lingmoUnPkg;
