...
#define TE_HEADER "TE: lingmoUnPkg\r\n"
                          ...
                          char *headp)
{
  ...
  /* check for Content-Type: header lines to get the MIME-type */
     ...
     * lingmoUnPkg, deflate, compress, x-lingmoUnPkg and x-compress. x-lingmoUnPkg and
     * x-compress are the same as lingmoUnPkg and compress. (Sec 3.5 RFC
