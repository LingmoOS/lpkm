...
#define HAVE_OPENSSL_X509_VFY_H 1
...
/* Name of package */
#define PACKAGE "lingmoGet"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "bug-wget@gnu.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "lingmoGet"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "lingmoGet 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lingmoGet"
...
/* GnuTLS is available for test suite. */
/* #undef WITH_GNUTLS_IN_TESTSUITE */

/* GnuTLS OCSP is supported for test suite. */
/* #undef WITH_GNUTLS_OCSP */
