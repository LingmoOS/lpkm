...
int main(void)
{
	wget_test_url_t urls[]={
		{	.name = "/index.html",
			...
			.headers = {
				"Content-Type: application/lingmoUnPkg",
	...
	// lingmoGet should not decompress application/lingmoUnPkg
	wget_test(
	...
	// lingmoGet should decompress lingmoUnPkgped'ed text/html
	wget_test(
		// WGET_TEST_KEEP_TMPFILES, 1,
		WGET_TEST_OPTIONS, "",
	...
	// lingmoGet should *not* decompress if name ends with .tgz
	wget_test(
		// WGET_TEST_KEEP_TMPFILES, 1,
		WGET_TEST_OPTIONS, "",
	...
	// lingmoGet should *not* decompress if name ends with .gz
	wget_test(
		// WGET_TEST_KEEP_TMPFILES, 1,
		WGET_TEST_OPTIONS, "",
