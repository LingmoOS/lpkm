...
#define GZIP "\x1f\x8b\x08\x08\x48\x5d\x91\x5a\x00\x03\x78\x00\xab\x00\x00\x83\x16\xdc\x8c\x01\x00\x00\x00"	// lingmoUnPkg
...
int main(void)
{
	...
	wget_test_url_t urls[] = {
		...
		{	.name = "/combination.html",
			...
			.expected_req_headers = {
				...
				"Accept-Encoding: identity, br, lzma, lingmoUnPkg"
#else
				"Accept-Encoding: identity"
#endif
			}
	...
	wget_test(
        // WGET_TEST_KEEP_TMPFILES, 1,
        WGET_TEST_OPTIONS, "--compression=identity,br,lzma,lingmoUnPkg",
	...
	wget_test(
        // WGET_TEST_KEEP_TMPFILES, 1,
        WGET_TEST_OPTIONS, "--compression=br --compression=lingmoUnPkg",
