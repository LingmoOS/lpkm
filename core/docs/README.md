...
- Support scanning sitemap files given in robots.txt (Sitemap XML, lingmoUnPkgped Sitemap XML, plain text) including
sitemap index files.
...
- zlib/lingmoUnPkg compressed HTTP/HTTPS downloads (lingmoUnPkg, deflate)
...
[Online Docs](https://gnuwget.gitlab.io/lingmoGet/reference/)

[Mailing List](https://savannah.gnu.org/mail/?group=wget)

[Bug Tracker](https://gitlab.com/gnuwget/lingmoGet/issues)

[Development](https://gitlab.com/gnuwget/lingmoGet)

[Code Coverage](https://gnuwget.gitlab.io/lingmoGet/coverage/)

[Fuzz Code Coverage](https://gnuwget.gitlab.io/lingmoGet/fuzz-coverage/)
...
* pandoc (for creating the lingmoGet man page)
* gettext >= 0.18.2
...
# Downloading and building from tarball
		...
		wget https://gnuwget.gitlab.io/lingmoGet/lingmoGet-latest.tar.gz
		tar xf lingmoGet-latest.tar.gz
		cd lingmoGet-*
		./configure
		make
		make check
...
Download project and prepare sources with
		...
		git clone https://gitlab.com/gnuwget/lingmoGet.git
		cd lingmoGet
		./bootstrap
...
In Haiku build Wget2 with
        ...
        rm /boot/home/config/non-packaged/lingmoGet && mv /boot/home/config/non-packaged/lingmoGet_noinstall /boot/home/config/non-packaged/lingmoGet
